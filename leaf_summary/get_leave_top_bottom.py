...
def show_leave_top_bottom(ax, contours, p1_t, p2_b, p4_r, p5_l, p7_r, p8_l,
                          p10_r, p11_l, p13_t, p14_b, p16_t, p17_b):

    ax.plot(contours[:, 0], contours[:, 1], linewidth=2)
    ax.axis('image')
    ax.set_title('boundary and lines')

    ax.plot([p1_t[0], p2_b[0]], [p1_t[1], p2_b[1]], 'r-')
    ax.plot([p4_r[0], p5_l[0]], [p4_r[1], p5_l[1]], 'g-')
    ax.plot([p7_r[0], p8_l[0]], [p7_r[1], p8_l[1]], 'g-')
    ax.plot([p10_r[0], p11_l[0]], [p10_r[1], p11_l[1]], 'g-')
    ax.plot([p13_t[0], p14_b[0]], [p13_t[1], p14_b[1]], 'r-')
    ax.plot([p16_t[0], p17_b[0]], [p16_t[1], p17_b[1]], 'r-')
